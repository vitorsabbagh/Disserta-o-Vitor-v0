...
\section{Design Science Research Framework}
    ...
    \begin{description}
        \item[Context] The operational environment of well construction engineering, where practitioners require efficient and reliable access to vast amounts of technical and HSE-related\abbrev{HSE}{Health, Safety, and Environment} information.
