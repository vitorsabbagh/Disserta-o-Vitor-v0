...
\label{chap:first_experiment}
    ...
    \section{Evaluation}
        ...
        \subsection{Evaluation Methodology}
            ...
            To provide a clear visual representation of the experimental workflow, a Business Process Model and Notation (BPMN)\abbrev{BPMN}{Business Process Model and Notation} diagram is presented in Figure~\ref{fig:experimental_workflow}. This diagram illustrates the step-by-step process, from query submission to expert evaluation.
        ...
        \subsection{Dataset Creation}
            ...
            The dataset used for the experiments in this dissertation consists of proprietary and confidential information. In accordance with information security policies and confidentiality agreements, the raw data and source documents cannot be made public. The access services to these sources, implemented via APIs\abbrev{API}{Application Programming Interface}, are likewise private and protected
        ...
        \begin{landscape}
            ...
            \toprule
            \rowcolor{gray!20}
            \multicolumn{1}{|c|}{Input query} & \multicolumn{1}{c|}{Model} & \multicolumn{1}{c|}{Setup} & \multicolumn{1}{c|}{Final output} & \multicolumn{1}{c|}{Truth. \newline fulness} & \multicolumn{1}{c|}{Perfor- \newline mance} & \multicolumn{1}{c|}{Specialist \ Comments} \\
            \midrule
        ...
        \subsection{Discussion} 
            ...
            \subsubsection{Economic Efficiency.} 
                ...
                These estimates assume homogeneous usage patterns; they do not account for variations in workload, query complexity, or adoption levels across different knowledge worker roles or departments.
